...
voucher_html_body = """<body
    ducatus=""
    bgcolor="#ffffff"
    style="margin: 0; padding: 0; min-width: 100%; font-family: sans-serif"
  >
    <table
      width="100%"
      bgcolor="#ffffff"
      ...
      <tr>
        <td>
          <table
            ...
            cellspacing="0"
            border="0"
            style="border-collapse: separate; width: 100%; max-width: 1000px"
            width="100%"
          >
            <tr>
              <td
              ...
              >
                ...
                >
                  <tr>
                    <td
                      class="dear"
                      style="font-weight: 400; font-size: 20px; color: #404040"
                    >
                      Dear Partner,
                    </td>
                  </tr>
              ...
              >
                ...
                >
                  <tr>
                    <td
                      class="text"
                      style="font-size: 20px; color: #404040; font-weight: 300"
                    >
                      <ul class="list" style="padding-left: 20px">
                        <li style="margin-bottom: 10px">
                          Open your Ducatus Web Wallet or Ducatus Wallet app
                        </li>
                        <li style="margin-bottom: 10px">
                          On the menu, click Voucher then New Voucher
                        </li>
                        <li style="margin-bottom: 10px">
